...
class OAuthError(RuntimeError):
    ...
    def __init__(self, message='OAuth error occured.', *args, **kwargs):
...
class OAuth20Authentication(Authentication):
    ...
    def __init__(self, realm='API', *args, **kwargs):
        self.realm = realm
        logger.info("OAuth20Authentication initialized; realm: %s"%self.realm)
        super(OAuth20Authentication, self).__init__(*args, **kwargs)
    ...
    def is_authenticated(self, request, **kwargs):
        ...
        or in a POST body.
        """
        logger.info("OAuth20Authentication: calling is_authenticated")
        ...
        try:
            ...
            if not key:
                logger.info('OAuth20Authentication. No consumer_key found.')
                return None
            """
            ...
            logger.info("Error in OAuth20Authentication.")
